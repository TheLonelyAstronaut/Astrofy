...
export const getIsUserFetching: Selector<
	ApplicationState,
	boolean
> = createSelector(getUserRootState, (user: AuthState) => user.isFetching);

export const getAuthError: Selector<
	ApplicationState,
	Error | undefined
> = createSelector(getUserRootState, (user: AuthState) => user.error);
